...
<!DOCTYPE html>
<html lang="en">
<jsp:include page="/view/Html/Head.jsp"></jsp:include>
<body>
	...
	<div class="wrapper">
		...
		<a class="fill" href="<%=request.getContextPath()%>/TrangChu">GO BACK HOME</a>
	</div>

	<jsp:include page="/view/Html/Script.jsp"></jsp:include>
</body>
</html>