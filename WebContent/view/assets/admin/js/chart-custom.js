...
if (jQuery('#apex-bar').length) {
    var options = {
        ...
        series: [{
            data: [ 1, 580, 690, 1100, 1200, 1380]
        }],
        xaxis: {
            categories: [ 'Italy', 'France', 'Japan', 'United States', 'China', 'Germany'],
        }
    }
...
if (jQuery('#am-3dpie-chart').length) {
    am4core.ready(function() {
        ...
        chart.data = [{
            country: $('#nameTeacher1').html(),
            litres: $('#dataTeacher1').html(),
        }, {
        	country: $('#nameTeacher2').html(),
            litres: $('#dataTeacher2').html(),
        }, {
        	country: $('#nameTeacher3').html(),
            litres: $('#dataTeacher3').html(),
        }, {
        	country: $('#nameTeacher4').html(),
            litres: $('#dataTeacher4').html(),
        }, {
        	country: $('#nameTeacher5').html(),
            litres: $('#dataTeacher5').html(),
        }, {
        	country: $('#nameTeacher0').html(),
            litres: $('#dataTeacher0').html(),
        }];
 ...
 jQuery("#home-chart-06").length && am4core.ready(function() {
  ...
  jQuery("#home-servey-chart").length && am4core.ready(function() {
   ...
   jQuery("#doc-chart-01").length && am4core.ready(function() {
    ...
    var name1=document.getElementById('nameCourse1').innerHTML;
    var splitted = name1.split(" ", 3);
    console.log(splitted);

    chart.data = [{
     "country": document.getElementById('nameCourse0').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse0').innerHTML
    }, {
     "country": document.getElementById('nameCourse1').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse1').innerHTML
    }, {
     "country": document.getElementById('nameCourse2').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse2').innerHTML
    }, {
     "country": document.getElementById('nameCourse3').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse3').innerHTML
    }, {
     "country": document.getElementById('nameCourse4').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse4').innerHTML
    }, {
     "country":document.getElementById('nameCourse5').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse5').innerHTML
    }, {
     "country":document.getElementById('nameCourse6').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse6').innerHTML
    }, {
     "country": document.getElementById('nameCourse7').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse7').innerHTML
    }, {
     "country":document.getElementById('nameCourse8').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse8').innerHTML
    }, {
     "country": document.getElementById('nameCourse9').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse9').innerHTML
    }, {
     "country": document.getElementById('nameCourse10').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse10').innerHTML
    }, {
     "country": document.getElementById('nameCourse11').innerHTML.slice(0, 20)+"...",
     "visits": document.getElementById('dataCourse11').innerHTML
    }];
